...
var tokenTxA = null;
var tokenA = tokenContract.new("TokenA", "ERC20A", 16, {from: eth.accounts[1], data: tokenCompiled.TestERC20Token.code, gas: 800000},
  function(e, contract) {
    if (!e) {
      if (!contract.address) {
...
var tokenTxB = null;
var tokenB = tokenContract.new("TokenB", "ERC20B", 18, {from: eth.accounts[1], data: tokenCompiled.TestERC20Token.code, gas: 600000},
  function(e, contract) {
    if (!e) {
      if (!contract.address) {
...
var tokenTxC = null;
var tokenC = tokenContract.new("TokenC", "ERC20C", 18, {from: eth.accounts[1], data: tokenCompiled.TestERC20Token.code, gas: 600000},
  function(e, contract) {
    if (!e) {
      if (!contract.address) {
